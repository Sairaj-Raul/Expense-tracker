...
export default function Income() {
  ...
  }, [incomeTransactions, filters, globalSearch]);
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-gray-600">Manage your income transactions</p>
        </div>
          ...
          <Button
            ...
            onClick={() =>
              exportTransactionsToCSV(
                ...
                `income_${new Date().toISOString().split("T")[0]}.csv`
              )
            }
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="text-right">
              ...
              <p className="mt-1 text-xl font-semibold">
                ...
                {filteredTransactions.length !== incomeTransactions.length && (
                  <span className="ml-2 text-sm font-normal text-gray-500">
                    of {incomeTransactions.length}
                  </span>
                )}
              </p>
            </div>
      ...
      <Card>
        <CardContent className="p-6">
          <h2 className="mb-4 text-xl font-semibold">Income Transactions</h2>
